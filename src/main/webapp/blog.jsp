...
<body>
  ...
  <div class="page-banner overlay-dark bg-image" style="background-image: url(resources/img/bg_image_1.jpg);">
          ...
          <div class="row">
            <div class="col-sm-6 py-3">
              <div class="card-blog">
                ...
                <div class="body">
                  <h5 ><a href="https://www.nature.com/articles/d41586-022-00403-0">List of Countries without Coronavirus case</a></h5>
                  <div class="site-info">
              ...
              <div class="card-blog">
                ...
                <div class="body">
                  ...
                  <div class="site-info">
                    <div class="avatar mr-2">
                      <div class="avatar-img">
                        <img src="resources/img/person/person_4.jpg" alt="">
                      </div>
              ...
              <div class="card-blog">
                ...
                <div class="body">
                  ...
                  <div class="site-info">
                    <div class="avatar mr-2">
                      <div class="avatar-img">
                        <img src="resources/img/person/person_3.jpg" alt="">
                      </div>
            ...
            <div class="col-sm-6 py-3">
              <div class="card-blog">
                <div class="header">
                  ...
                  <a href="blog-details" class="post-thumb">
                    <img src="resources/img/blog/blog_4.jpg" alt="">
                  </a>
                </div>
                <div class="body">
            ...
            <div class="col-sm-6 py-3">
              <div class="card-blog">
                <div class="header">
                  ...
                  <a href="blog-details" class="post-thumb">
                    <img src="resources/img/blog/blog_5.jpg" alt="">
                  </a>
                </div>
                <div class="body">
      ...
      <div class="row align-items-center">
        <div class="col-lg-4 wow zoomIn">
          <div class="img-banner d-none d-lg-block">
            <img src="resources/img/mobile_app.png" alt="">
          </div>
        </div>
        <div class="col-lg-8 wow fadeInRight">
          <h1 class="font-weight-normal mb-3">Get easy access of all features using One Health Application</h1>
          <a href="#"><img src="resources/img/google_play.svg" alt=""></a>
          <a href="#" class="ml-2"><img src="resources/img/app_store.svg" alt=""></a>
        </div>
      </div> <!-- .row -->
    </div> <!-- .container -->
  </div> <!-- .banner-home -->
